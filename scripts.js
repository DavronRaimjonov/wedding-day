...
const LOCALES = {
  ru: {
    pageTitle: "Робия и Абдулазиз | Свадебное приглашение",
    metaDescription:
      "Свадебное приглашение Робия и Абдулазиз на 13 июнь 2026 года.",
    ariaIntro: "Конверт с приглашением",
    ariaEnvelope: "Запечатанный бумажный конверт",
    ariaWeddingDate: "Дата свадьбы",
    ariaCalendar: "Календарь июнь 2026 с выделенным 13 июнь",
    ...
    withLove: "с любовью,",
    signatureNames: "Абдулазиз\u00a0и\u00a0Робия",
    ornamentNames:
      '<span class="ornament-name-line">Абдулазиз</span><span class="ornament-name-amp">и</span><span class="ornament-name-line">Робия</span>',
    ...
    venueName: "ресторан Shohona",
    venueAddress: "Янгиюльский район",
    venueLandmark: "Ориентир: Янгиюльский район, свадебный зал Shohona.",
  ...
  uz: {
    pageTitle: "Robiya va Abdulaziz | To'y taklifnomasi",
    metaDescription:
      "Robiya va Abdulazizning 2026-yil 13-iyun kungi to'y taklifnomasi.",
    ...
    signatureNames: "Abdulaziz\u00a0va\u00a0Robiya",
    ornamentNames:
      '<span class="ornament-name-line">Abdulaziz</span><span class="ornament-name-amp">va</span><span class="ornament-name-line">Robiya</span>',
    ...
    venueName: "Shohona restorani",
    venueAddress: "Yangiyo'l tumani",
    venueLandmark: "Mo'ljal: Yangiyo'l tumani Shohona to'yxonasi",
